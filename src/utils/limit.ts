...
export const isLimitedByGender = (userInfo: UserState | undefined, boardData: BoardInfo) => {
...
export const isLimitedByAge = (userInfo: UserState | undefined, boardData: BoardInfo) => {
  if (!userInfo) return false;
